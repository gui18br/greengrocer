...
import 'package:greengrocer/src/pages/home/view/components/item_title.dart';
          ...
          actions: [
            Padding(
              ...
              child: GestureDetector(
                onTap: () {},
                child: Badge(
                    backgroundColor: CustomColors.customConstrantColor,
                    label: const Text(
                      '2',
                ...
                child: TextFormField(
                  decoration: InputDecoration(
                      ...
                      prefixIcon: Icon(Icons.search,
                          color: CustomColors.customConstrantColor, size: 21),
